import {HtmlElement, Section, FlexCol, PureContainer, TextField, NumberField, MonthField, Select, Button, Grid, Pagination, Link, List, Text, ValidationGroup} from 'cx/widgets';
        ...
        <FlexCol style="flex: 1 1 0%">
            <PureContainer putInto="header">
                ...
                <div style="margin: -10px">
                    ...
                    &nbsp;
                    <Button text="New Order" onClick="onNewOrder" mod="hollow"/>
                </div>
            </PureContainer>
            <Grid
                        ...
                        header: {
                            ...
                            items: <cx>
                                <div>
                                    Date
                                    <br/>
                                    <MonthField style="width:100%;margin-top:5px" range
            ...
            <div style="border-top: 1px solid lightgray; padding: 10px">
